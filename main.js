...
function setup(){
    ...
    canvas.center();
    background("white");
    canvas.mouseReleased(identify_doodle);
}
...
function classifyCanvas(){
    classifier.classify(canvas,get_result);
}
...
function get_results(e,r){
    if(e){
        console.error(e);
         ...
         document.getElementById("p1").innerHTML="label: "+doodle_name;
         document.getElementById("sketch_confidence").innerHTML="confidence: "+doodle_confidence +"%";
         utterThis=new SpeechSynthesisUtterance(doodle_name);
